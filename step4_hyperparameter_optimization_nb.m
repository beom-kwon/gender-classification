...
output_file = strcat(output_path,'fitcnb_JSE.mat');
...
for p = person_list
    ...
    nb_model = fitcnb(X,Y,'OptimizeHyperparameters','all',...
        'HyperparameterOptimizationOptions',...
        struct('AcquisitionFunctionName','expected-improvement-plus',...
        'Verbose',0,'ShowPlots',0));
    
    nb_model = compact(nb_model); % If you use MATLAB R2020b
    cnt = cnt + 1;
    optimized_model(cnt,:) = {p,nb_model};
    toc
end
