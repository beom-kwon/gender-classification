...
input_file2 = strcat(pwd,dataset_name,'\trained_model\fitcnb_JSE.mat');
output_file = strcat(output_path,'results_fitcnb_JSE.mat');
...
for p = person_list
    ...
    nb_model = optimized_model{p,2};

    [label, score, cost] = predict(nb_model, X);
