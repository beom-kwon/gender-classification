...
input_file2 = strcat(pwd,dataset_name,'\trained_model\fitctree_JSE.mat');
output_file = strcat(output_path,'results_fitctree_JSE.mat');
...
for p = person_list
    ...
    tree_model = optimized_model{p,2};

    [label, score, cost] = predict(tree_model, X);
